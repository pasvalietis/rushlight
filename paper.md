...
![[]{label="Figure 1"} The top row of images are SunPy maps created from observables captured by AIA / XRT spacecraft of an eruptive solar flare event occurring on 2012-07-19. The bottom row of images are synthetic observable SunPy maps created by the alignment and subsequent projection of UV emission along the spacecraft's line of sight. An identical Coronal Loop Builder object is plotted in each case to provide a visual comparison of scaling and alignment across the real and synthetic observables.](PAPER_COMPARE.png)
